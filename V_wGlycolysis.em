...
erg1 = {
       "V" : 1.0,
       "EMB" : 2.0,
       "LAT" : 0.3, #150104 based on Kato et al., 1996 (0.8/2.73)
       "NEO" : 1.5,
       "SAN" : 1.0
}
...
KCNQ1 = {
       "V" : 1.0,
       "EMB" : 0.3, #150104 assumed to be unchanged during embryonic period
       "LAT" : 0.3, #150104 based on Kato et al., 1996 (0.8/2.73)
       "NEO" : 2.0,
       "SAN" : 1.0
}
...
CurrentClamp_amplitude = 0 #38 pA/pF 150202
...
#<variable name="NADH" initial_value="0.8948906751612181" units="mM" />
	Variable Variable( NADH )
        ...
        @include('Glycogenolysis_0202.em')
